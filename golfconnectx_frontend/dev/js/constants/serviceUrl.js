...
export const SERVICE_URLS ={
    ...
    GET_GOLF_MEMBERS: devUrl +  'api/directory/send-friend-request',
    ...
    FORUM_CONVERSATIONS:devUrl+'api/courses/',
    ...
    FORUM_POST:devUrl+'api/courses/',
    FORUM_COMMENT:devUrl+'api/forums/courses/course/',
    FORUM_SEARCH:devUrl+'api/courses/',
    ...
    FB_LOGIN:devUrl+'api/user/fb-login',
    CREATEEVENT_GROUP:devUrl+'api/groups/',
    SEARCH_INVITE:devUrl+'api/events/',
    EVENTLIST_PUBLIC:devUrl+'api/events/public-events',
    REQUEST_INVITE:devUrl+'api/events/',
    DIRECTORY: devUrl + 'api/directory/',
    PUBLIC_CALENDAR_EVENTS: devUrl + 'api/events/public-events/calendar-list',
    PUBLIC_CALENDAR_DAY_EVENTS: devUrl + '/api/events/public-events/calendar',
    DELETE_GROUP_IMAGE:devUrl+'api/groups/delete-image/',
    DELETE_EVENT_IMAGE:devUrl+'api/events/delete-image/',
    DELETE_POSTS:devUrl+'api/posts/',
    DELETE_COMMENTS:devUrl+'api/posts/',
    DELETE_GROUP_FILE:devUrl+'api/groups/delete-group-file/',
    DELETE_EVENT_FILE:devUrl+'api/events/delete-teetime-file/',
    GET_TEETIME_FILES:devUrl+'api/events/',
    FB_LOGIN_WITH_ZIPCODE:devUrl+'api/user/fb-register/',
    DELETE_SCORES:devUrl+'api/profile/courses/',
    DELETE_POST_PHOTO:devUrl+'api/posts/'
	};
