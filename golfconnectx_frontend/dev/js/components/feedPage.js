...
class FeedPage extends React.Component {
   constructor(props){
       super(props);
       this.state={
      posts: Object.assign([], props.postList),  ajaxCallInProgress:false, cimgArray:'', imgId:'',pImgId:''
    };
   }
   componentWillMount(){
 ...
 Comment(postsId){
      ...
      let innerDescValue = document.getElementById(commentTextBox).value.replace(new RegExp('\r?\n','g'), '<br />');
          console.log('innrHtml', innerDescValue);
        let body;
         ...
         {this.state.posts!=undefined && this.state.posts!=null ? this.state.posts.map((item,i)=>{
            ...
            <div className="col-sm-12 zeroPad">
              <div className="col-sm-1 wd6pc">
               ...
               <div className="user1-header col-sm-6 ">
               ...
               <div className="user1-spl">
                 {this.props.activeUser.id==item.author.id?<span className="glyphicon glyphicon-trash fr cursor-pointer mt1pc" data-toggle="modal" data-target="#modalPostDelet"></span>:''}
                  <h3>{item.title}</h3>
                     ...
                     <div className="col-sm-12 rspnsng">
                      {/* <img src="/assets/img/Camera Icon.png" className="fr mr4_5pc" />
                         <input type="file" id="postFile" name="postFile" className="postCameraImg" onChange={this.postImage.bind(this,item.id)} multiple/>*/}
                          ...
                          {/*<img src="assets/img/Add Photo@3x.png"  className="fleft feedAddImg" onClick={this.openUploadImage.bind(this)} />*/}
              ...
              return(<div key={childIndex} className="col-sm-12 mt-6pc" >
                    ...
                    <div className="col-sm-12 mt3pc pdryt0px">
                     <span className="glyphicon glyphicon-trash fr cursor-pointer mt1pc top40px" data-toggle="modal" data-target="#modalCommentDlt"></span>
                    ...
                    <i className="glyphicon glyphicon-remove top-55px cursor-pointer" data-toggle="modal"  onClick={this.checkId.bind(this,cimgItem.id)} ></i>
            ...
            <div id={item.id+ "_commentSection"} className="commentSection" >
                  <div className="cmnt-matter">
                            <textarea type="text" maxLength="500" className="txtarea form-control" placeholder="Write Something..." id={item.id+ "_txtComment"}></textarea>
                            <img src="/assets/img/Camera Icon.png" className="fr cameraCommentImg" />
                            <input type="file" id="commentFile" name="commentFile" className="commentCameraImg" onChange={this.commentImage.bind(this)} multiple />
                  </div>
