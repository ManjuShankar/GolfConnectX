                ...
                <div className="col-sm-7 col-md-7 mt2pc">
                    <div className="col-sm-12 col-md-12">
                        <div className="navHeader">
                            <button className="pstbtn btnPost" data-toggle="modal" data-target="#" onClick={this.onPostClick.bind(this)}><img src="/assets/img/icons/POSTicon.png" className="postImgIcon"/>POST</button>
                                   ...
                                   <div className="modal-body col-sm-12 bgwhite mb0px">
                                       ...
                                       <div id="groups"  className="tab-pane active yyy">
                                                {(this.state.isGroupSelected)?(<select className="form-control" onChange={this.onFieldChange} id="selection" name="group">
                                                  {_.size(this.props.savePost)>0 && this.props.savePost!=undefined && this.props.savePost!=null && this.props.savePost.groups.map((item,i)=>{
                                                ...
                                                <select className="form-control" id="selection" name="event" onChange={this.onFieldChange}>
                                                     {_.size(this.props.savePost)>0 &&  this.props.savePost!=undefined  && this.props.savePost!=null  && this.props.savePost.events.map((item,i)=>{
                            ...
                            <button className="btnfrndInvit"  onClick={this.callModal.bind(this)}><img src="/assets/img/icons/FriendIcon.png" className="headerInviteFriend"/> Add Friends</button>
                           ...
                           <Link to="/notifications" className="notifyLine">{(this.state.notificationCount>0)?(<span className="badge notifyCount">{this.state.notificationCount}</span>):(<span></span>)}<button className="notiButton m0px glyphicon glyphicon-bell notificationsIcon"></button></Link>
...
function matchDispatchToProps(dispatch){
    return bindActionCreators({userSignOut, savePostDetails, getNotificationsCount, invite, getPostList, searchAll, contactUs,getGolfConnectXmembers}, dispatch);
}
